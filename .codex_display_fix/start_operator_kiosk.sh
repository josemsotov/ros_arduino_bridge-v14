...
if [ -x "/home/josemsotov/SMART_TROLLEY_INSTALLATION/scripts/apply_touch_primary.sh" ]; then
  echo "$(date --iso-8601=seconds) applying DSI-2 as primary display"
  /home/josemsotov/SMART_TROLLEY_INSTALLATION/scripts/apply_touch_primary.sh || true
  sleep 1
fi
