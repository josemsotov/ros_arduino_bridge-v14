...
class SharedState:
    def __init__(self) -> None:
        ...
        self.robot_mode: str = "STADIA"  # Safe default; camera modes require explicit selection
...
class OperatorNode(Node):
    def __init__(self, state: SharedState) -> None:
        ...
        self.pub_gesture_enable = self.create_publisher(Bool, "/gesture/enable", 10)
    ...
    def set_robot_mode(self, mode: str) -> None:
        ...
        if mode == "FOLLOWER":
            ...
            self.publish_stop()
        self.pub_gesture_enable.publish(Bool(data=(mode == "GESTURE")))
        with self.state.lock:
