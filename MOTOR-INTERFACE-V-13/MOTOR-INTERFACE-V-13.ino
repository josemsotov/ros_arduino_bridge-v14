...
// Libreria EEPROM para persistencia de configuracion de dirección
#include <EEPROM.h>
...
void setup() {
  ...
  // El banner de versión ya se imprime dentro de initializeSystem() (Core_Functions.h)
  // No duplicar aquí.
...
void loop() {
  ...
  // ===== BLUETOOTH UPDATE =====
    ...
    bt_update();                  // Leer datos BT y actualizar estado conexión
  #endif

  // ===== GPS UPDATE =====
  #ifdef ENABLE_GPS
    gps_update();                 // Leer tramas NMEA y actualizar posición
  #endif
